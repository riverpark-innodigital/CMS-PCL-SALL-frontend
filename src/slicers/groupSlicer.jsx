...
export const getGroupById = createAsyncThunk(
  "productGroup/getGroupById",
  async (groupId) => {
    try {
      const response = await AxiosInstance.get(
        `/productGroup/group/${groupId}`
      );
      // console.log(
...
export const updateGroupById = createAsyncThunk(
  "productGroup/updateGroupById",
  async (data) => {
    try {
      // console.log(data);

      const response = await AxiosInstanceMultipart.put(
        `/productGroup/group/${data.data.groupId}`,
        data.data.data
      );
      // console.log(
      //     "params {data} ->", data, "\n",
...
export const getGroupBySupId = createAsyncThunk(
  "productGroup/getGroupBySupId",
  async (data) => {
    try {
      const response = await AxiosInstance.get(
        `productGroup/groupbysup/${data}`
      );
      ...
      .addCase(updateGroupById.fulfilled, (state, action) => {
        ...
        if (action.payload.status) {
          state.groups = state.groups
            .map((groups) =>
              groups.GroupProductId === action.payload.data.GroupProductId
                ? action.payload.data
                : groups
            )
