      ...
      >
        <div className="min-h-[400px] max-h-[450px] overflow-y-auto">
          <div className="flex justify-start mb-2 gap-[20px] items-center">
            ...
            <div>
              ...
              <span className="block">
                The Company name is available for use.
              </span>
            </div>
          </div>
          <div className="w-full grid grid-cols-1 gap-[25px]">
            ...
            <MultiSelect
              ...
              defaultValue={buSelected}
              options={buOption}
              onChange={handlerChangeBuSelected}
            />
          </div>
          ...
          <div className="mt-5">
            <span className="text-gray-800 font-primaryMedium">
              Upload the company image <span className="text-red-500">*</span>
            </span>
          </div>
          <div className="w-full mt-1">
            ...
            >
              ...
              <p className="ant-upload-hint">PNG or JPG (Maximum 5mb)</p>
            </Dragger>
            <div className="mx-1 flex justify-end">
              {validfile && (
                <p className="text-red-500 text-[12px]">{validfile}</p>
              )}
            </div>
          </div>
          <div className="mt-5">
          ...
          <div className="w-full mt-1">
            ...
            >
              ...
              <p className="ant-upload-hint">PDF (Maximum 10mb)</p>
            </Dragger>
            <div className="mx-1 flex justify-end">
              {validCom && (
                <p className="text-red-500 text-[12px]">{validCom}</p>
              )}
            </div>
          </div>
        </div>
        <div className="w-full flex justify-end">
          <div className="gap-x-3 flex w-[30%] 2xl:w-[30%] mt-[25px] justify-end items-center">
            <OutlineBTN
              func={() => setOpenResponsive(false)}
              lable="Cancel"
              size="large"
            />
            <ButtonFullComponent
              isLoading={loading}
              lable="CREATE NEW COMPANY"
...
export const UpdateCompany = ({ comId, data }) => {
  ...
  const [buOption, setBuOption] = useState([]);
  const [buSelected, setBuSelected] = useState(
    data?.BusinessUnits?.map((bu) => bu?.businessUnitId)
  );
  const [validNameEN, setValidNameEN] = useState("");
  const [openResponsive, setOpenResponsive] = useState(false);
  const isFatching = useRef(false);
...
export const DeleteCompany = ({ comId }) => {
  ...
  return (
    <div>
      ...
      <Dialog open={size === "sm"} size={size || "md"} handler={handleOpen}>
        <DialogBody>
